...
#' @param risk.free Tasa libre de riesgo
...
#'
#' @examples
tangency_portfolio <- function (er, cov.mat, risk.free, shorts = TRUE) {
  ...
  #
  gmin.port <- ehansen::globalMin_portfolio(er, cov.mat, shorts=shorts)
